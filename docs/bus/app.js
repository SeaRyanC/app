...
(() => {
  ...
  function ItemCard({ material, onDragStart }) {
    return /* @__PURE__ */ u3(
      "button",
      {
        class: "item-card",
      ...
      /* @__PURE__ */ u3("main", { class: "workspace", children: [
        /* @__PURE__ */ u3("aside", { class: "catalog panel", children: [
          /* @__PURE__ */ u3("div", { class: "toolbar", children: [
            /* @__PURE__ */ u3("button", { onClick: undo, disabled: !history.length, title: "Undo (\u2318Z)", children: "\u21B6 Undo" }),
            /* @__PURE__ */ u3("button", { onClick: redo, disabled: !future.length, title: "Redo (\u21E7\u2318Z)", children: "\u21B7 Redo" }),
            /* @__PURE__ */ u3("button", { onClick: () => void share(), class: "share-button", children: "\u2197 Share link" }),
            /* @__PURE__ */ u3("button", { onClick: reset, class: "quiet-button", children: "Reset" })
          ] }),
          ...
          /* @__PURE__ */ u3("div", { class: "item-list", children: filteredMaterials.map((material) => /* @__PURE__ */ u3(ItemCard, { material, onDragStart }, material.id)) })
        ] }),
        /* @__PURE__ */ u3("section", { class: "planner panel", children: [
            ...
            /* @__PURE__ */ u3("div", { class: "bus-columns", ref: stageRef, children: [
              ...
              /* @__PURE__ */ u3(
                "div",
                {
                  ...
                  ] }) : plan.lanes.map((lane) => /* @__PURE__ */ u3(LaneColumn, { lane, onDragStart, onDrop: handleDrop, spineRef: (element) => registerLaneSpine(lane.id, element) }, lane.id))
                }
              ),
              ...
              /* @__PURE__ */ u3(BeltOverlay, { plan, stageRef, stationPortRefs, laneSpineRefs })
            ] }),
            /* @__PURE__ */ u3(
              "div",
              {
                ...
                children: "Drop an item here to add a station \xB7 use \u21C4 on a station to flip which side it taps from"
              }
            )
          ] }),
          plan.lanes.length > 0 && /* @__PURE__ */ u3("div", { class: "legend", children: [
            ...
            " counterflow ",
            /* @__PURE__ */ u3("span", { class: "legend-note", children: "Select a station to edit its bus inputs" })
          ] })
        ] })
      ] }),
  ...
  function connectorPath(start, rowOffset, laneX, kind, hopXs) {
  ...
  function BeltOverlay({ plan, stageRef, stationPortRefs, laneSpineRefs }) {
    ...
    for (const [stationId, list] of byStation) {
      ...
      withDistance.sort((a3, b2) => a3.dx - b2.dx);
    ...
    const laneSpineElements = plan.lanes.map((lane) => {
      ...
      return /* @__PURE__ */ u3("g", { children: [
        /* @__PURE__ */ u3("line", { class: "lane-spine", x1: range.x, y1: originY, x2: range.x, y2: range.top }),
        ...
        /* @__PURE__ */ u3("polygon", { class: "lane-arrowhead", points: `${range.x - 6},${range.top + 11} ${range.x + 6},${range.top + 11} ${range.x},${range.top}` })
      ] }, lane.id);
    });
    return /* @__PURE__ */ u3(
      "svg",
  ...
  function StationCard({ station, index, isFirst, isLast, selected, onSelect, onDragStart, onDrop, onToggleSide, onMove, portRef }) {
    return /* @__PURE__ */ u3(
      "div",
      {
        ...
        onKeyDown: (event) => {
          if (event.key === "Enter" || event.key === " ") onSelect(station.id);
        },
        ...
        title: `${materialName(station.material)} \xB7 station ${index + 1} \xB7 click to edit bus inputs`,
        children: [
          ...
          /* @__PURE__ */ u3("span", { class: "station-controls", children: [
            /* @__PURE__ */ u3(
              "button",
              {
                class: "move-button",
  ...
  function LaneColumn({ lane, onDragStart, onDrop, spineRef }) {
    const material = materialById.get(lane.material);
    return /* @__PURE__ */ u3("div", { class: "lane-column", draggable: true, onDragStart: () => onDragStart({ kind: "lane", id: lane.id }), onDragOver: (event) => event.preventDefault(), onDrop: (event) => onDrop(lane.id, event), title: material?.name ?? lane.material, children: [
      /* @__PURE__ */ u3("div", { class: "lane-header", children: /* @__PURE__ */ u3(MaterialIcon, { material }) }),
